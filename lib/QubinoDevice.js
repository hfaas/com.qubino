...
class QubinoDevice extends ZwaveDevice {
	...
	registerCapability(...args) {
		console.log('registerCapability() ->', args[0], this.multiChannelNodeObject);
	...
	customSaveMessage(oldSettings, newSettings, changedKeysArr = []) {
		if (changedKeysArr.includes(constants.settings.enableInput1) || changedKeysArr.includes(constants.settings.enableInput2) || changedKeysArr.includes(constants.settings.enableInput3) || changedKeysArr.includes(constants.settings.workingMode)) {
